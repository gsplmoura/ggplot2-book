...
[ggplot2: Elegant Graphics for Data Analysis (3e),](https://ggplot2-book.org/) Hadley Wickham
...
-   ggplot2 community on stackoverflow:

```{r}
install.packages(c(
  "tidyverse", 
  "colorBlindness", "directlabels", "ggforce", "gghighlight", 
  "ggnewscale", "ggraph", "ggrepel", "ggtext", "ggthemes", 
  "hexbin", "Hmisc", "mapproj", "maps", "munsell", "ozmaps", 
  "paletteer", "patchwork", "rmapshaper", "scico", "seriation", 
  "sf", "stars", "tidygraph", "wesanderson"
))
```
